...
(async () => {
  ...
  await page.goto('https://connect.beta.orufy.in/contacts/groups', { waitUntil: 'networkidle' });
  ...
  while (true) {
    ...
    if (groupCount === 0) {
      console.log('✅ All contact groups deleted.');
      break;
    }
    ...
    console.log('🗑️ Deleted one group.');
